...
# Import for views
from web.service.views import LastPositiveView, ValidateView, SettingsView, LoginView, AnalyzeView, LogOutView
...
app.add_url_rule('/', view_func=LastPositiveView.as_view('explore_root_view'))
app.add_url_rule('/explore', view_func=LastPositiveView.as_view('explore_view'))
